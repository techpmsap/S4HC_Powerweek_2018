...
<tr><td colspan=2><h1>EXERCISE 01 - BUILDING A PROJECT WITH THE NEO ARCHETYPE</h1></td></tr>
...
1. Enter the command
	...
	```
	mvn archetype:generate -DarchetypeGroupId=com.sap.cloud.s4hana.archetypes -DarchetypeArtifactId=scp-neo-javaee6 -DarchetypeVersion=1.9.4
	```
